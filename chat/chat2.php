...
require_once '../funcoes/senha_dia.php';
$senha = senha_dia();
...
<body class="p-3 m-0 border-0 bd-example m-0 border-0">
    ...
    <nav class="navbar bg-body-dark fixed-top">
        <div class="container-fluid"><br>
            <a class="navbar-brand" href="#"><strong>SENHA DO DIA - <?php print_r($senha['senha_dia'])?></strong></a>
    ...
    <div class="modal fade" id="ModalCriare" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">CHICO ALI-CHAT - <?php print_r($senha['senha_dia'])?></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
