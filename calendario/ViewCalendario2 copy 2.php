...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <!-- <a href="../calendario/Informacao_dia_calendario.php"></a> -->
                <?php
                $mes = $mess;
                $ano = $anos;
                ...
                for ($i = 0; $i < 6; $i++) {
                    ...
                    for ($j = 0; $j < 7; $j++) {
                        if ($i == 0 && $j < $primeiroDiaSemana - 1) {
                            ...
                            // $ano = '2023';
                            // $dia = '06';
                            $dias = STR_PAD($dia, 2, '0', STR_PAD_LEFT);
                            ...
                            $resultado->bindValue(':mes', $mess);
                            $resultado->bindValue(':ano', $anos);
                            $resultado->execute();
                            ...
                            foreach ($r as $resultados) {
                                ...
                                } else if ($resultados['total_nivel'] == 0) {
