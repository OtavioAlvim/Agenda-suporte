<?php
// include_once('C:\Users\tavin\OneDrive\htdocs\calendario2\funcoes\carrega_calendario.php');
require_once 'C:\Users\tavin\OneDrive\htdocs\calendario2\funcoes\carrega_calendario.php';
...
<body>
    ...
    <br>
    <div class="container">
        <a class="btn btn-primary" href="../home/ViewHome.php" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
            ...
            <div class="col-md-10">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                        $calendario = carrega_calendario('junho', 2023);
                        // print_r($calendario);
